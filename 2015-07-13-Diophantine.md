...
Lisp 不会自动求出 3245/1000 的结果，因此计算过程是分数的计算而非浮点运算，可以得到精确结果。但如果用浮点数实现的话，可能导致 [数值灾难](http://zh.wikipedia.org/zh-cn/%E6%B5%AE%E7%82%B9%E6%95%B0 "数值灾难")。

由于浮点数被用以在计算机中对实数进行**近似**表示，因此浮点运算与数学运算有所差异。为了得到精确的结果，需要用 [欧几里得 GCD 算法](http://zh.wikipedia.org/wiki/%E8%BC%BE%E8%BD%89%E7%9B%B8%E9%99%A4%E6%B3%95#.E4.B8.BE.E4.BE.8B) 的变体作为替代。
