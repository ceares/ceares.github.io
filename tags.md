...
<a href="#{{ tag[0] }}" title="{{ tag[0] }}" rel="{{ tag[1].size }}" style="margin-right:2em"><i class="fa fa-tags">&nbsp;&nbsp;<span style='font-family:"Helvetica Neue",Arial,"Hiragino Sans GB","STHeiti","Microsoft YaHei","WenQuanYi Micro Hei",SimSun,sans-serif'>{{ tag[0] }}</span></i></a>
{% endfor %}
</div>
