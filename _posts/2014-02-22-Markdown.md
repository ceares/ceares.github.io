...
M↓ 已被许多平台支持，如 Typora[^Typora]、StackEdit[^stackedit]、Classeur[^classeur]、作业部落[^zybuluo]、为知笔记[^wiz]、博客园[^cnblogs]、简书[^jiansh]、小书匠[^xiaoshujiang]、马克飞象[^Evernote]、GitHub[^GitHub]、Pandoc[^Pandoc] 等等。
